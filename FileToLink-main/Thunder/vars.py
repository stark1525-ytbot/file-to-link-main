...
class Var:
    ...
    if force_channel_env:
        try:
            ...
            logger.warning(f"Invalid FORCE_CHANNEL_ID '{force_channel_env}'")
    ...
    MAX_QUEUE_SIZE: int = int(os.getenv("MAX_QUEUE_SIZE", "100"))# Thunder/vars.py
